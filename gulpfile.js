...
gulp.task('browserify', function() {
    ...
    if (!debug) {
        bundler = bundler.pipe(streamify(uglify()));
    }
...
var remoteAssetBase = 'https://s3.amazonaws.com/musedlab-nyphil/';
var localAssetBase  = 'https://musedbox.com/mused-assets/nyphil/';
